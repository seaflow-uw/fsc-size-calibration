...
png(paste0(inst,"-Size-scatter.png"),width=12, height=12, unit='in', res=100)
  ...
  legend("topleft",legend=c(as.vector(culture2$Group.1),"Mie-based model (index refraction = 1.026 +/- 0.009)","beads"), pch=c(rep(21,nrow(culture2)),NA, 13), lwd=c(rep(NA,nrow(culture2)),2, NA), bty='n',
